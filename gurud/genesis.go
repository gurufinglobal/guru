...
// enable ALL precompiles, and include default preinstalled contracts (e.g. Create2, Multicall3).
...
func NewErc20GenesisState() *erc20types.GenesisState {
	...
	erc20GenState.NativePrecompiles = []string{testconstants.WGURUContractMainnet}
