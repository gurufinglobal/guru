...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.GURUD, addr sdk.AccAddress, balance math.Int, rewards ...math.Int) (sdk.Context, error) {
	t.Helper()
