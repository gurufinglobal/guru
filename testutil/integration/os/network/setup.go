...
type genSetupFn func(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, customGenesis interface{}) (gurutypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *exampleapp.GURUD, genesisState gurutypes.GenesisState, _ interface{}) (gurutypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, customGenesis interface{}) (gurutypes.GenesisState, error) {
		moduleGenesis, ok := customGenesis.(T)
		if !ok {
			return nil, fmt.Errorf("invalid type %T for %s module genesis state", customGenesis, moduleName)
		}

		genesisState[moduleName] = guruApp.AppCodec().MustMarshalJSON(moduleGenesis)
		return genesisState, nil
	}
}
...
func setDefaultStakingGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, overwriteParams StakingCustomGenesisState) gurutypes.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}
...
func setDefaultBankGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, overwriteParams BankCustomGenesisState) gurutypes.GenesisState {
...
func setDefaultSlashingGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, overwriteParams SlashingCustomGenesisState) gurutypes.GenesisState {
	...
	genesisState[slashingtypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(slashingGen)
	return genesisState
}

// setBankGenesisState updates the bank genesis state with custom genesis state
func setBankGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, customGenesis interface{}) (gurutypes.GenesisState, error) {
	...
	guruApp.AppCodec().MustUnmarshalJSON(genesisState[banktypes.ModuleName], bankGen)
	...
	genesisState[banktypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(bankGen)
	return genesisState, nil
}
...
func setDefaultAuthGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, genAccs []authtypes.GenesisAccount) gurutypes.GenesisState {
	defaultAuthGen := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccs)
	genesisState[authtypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(defaultAuthGen)
	return genesisState
}

// setAuthGenesisState updates the bank genesis state with custom genesis state
func setAuthGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, customGenesis interface{}) (gurutypes.GenesisState, error) {
	...
	guruApp.AppCodec().MustUnmarshalJSON(genesisState[authtypes.ModuleName], authGen)
	...
	genesisState[authtypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(authGen)
	return genesisState, nil
}
...
func setDefaultGovGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, overwriteParams GovCustomGenesisState) gurutypes.GenesisState {
	...
	genesisState[govtypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(govGen)
	return genesisState
}
...
func setDefaultFeeMarketGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) gurutypes.GenesisState {
	fmGen := feemarkettypes.DefaultGenesisState()
	fmGen.Params.BaseFee = overwriteParams.baseFee
	genesisState[feemarkettypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(fmGen)
	return genesisState
}
...
func setDefaultMintGenesisState(guruApp *exampleapp.GURUD, genesisState gurutypes.GenesisState, overwriteParams MintCustomGenesisState) gurutypes.GenesisState {
	...
	genesisState[minttypes.ModuleName] = guruApp.AppCodec().MustMarshalJSON(mintGen)
	return genesisState
}

func setDefaultErc20GenesisState(guruApp *exampleapp.GURUD, evmChainID uint64, genesisState gurutypes.GenesisState) gurutypes.GenesisState {
	...
	updatedErc20Gen := updateErc20GenesisStateForChainID(testconstants.ChainID{
		ChainID:    guruApp.ChainID(),
		EVMChainID: evmChainID,
	}, *erc20Gen)

	genesisState[erc20types.ModuleName] = guruApp.AppCodec().MustMarshalJSON(&updatedErc20Gen)
	return genesisState
}
...
func newDefaultGenesisState(guruApp *exampleapp.GURUD, evmChainID uint64, params defaultGenesisParams) gurutypes.GenesisState {
	genesisState := guruApp.DefaultGenesis()

	genesisState = setDefaultAuthGenesisState(guruApp, genesisState, params.genAccounts)
	genesisState = setDefaultStakingGenesisState(guruApp, genesisState, params.staking)
	genesisState = setDefaultBankGenesisState(guruApp, genesisState, params.bank)
	genesisState = setDefaultGovGenesisState(guruApp, genesisState, params.gov)
...
func customizeGenesis(guruApp *exampleapp.GURUD, customGen CustomGenesisState, genesisState gurutypes.GenesisState) (gurutypes.GenesisState, error) {
	var err error
	for mod, modGenState := range customGen {
		if fn, found := genesisSetupFunctions[mod]; found {
			genesisState, err = fn(guruApp, genesisState, modGenState)
			if err != nil {
