...
type Params struct {
	...
	GasPriceAdjustmentFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,9,opt,name=gas_price_adjustment_factor,json=gasPriceAdjustmentFactor,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"gas_price_adjustment_factor"`
	...
	MaxChangeRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,10,opt,name=max_change_rate,json=maxChangeRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"max_change_rate"`
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_4f4e223756c19511, []int{0}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "guru.feemarket.v1.Params")
}

func init() { proto.RegisterFile("guru/feemarket/v1/feemarket.proto", fileDescriptor_4f4e223756c19511) }

var fileDescriptor_4f4e223756c19511 = []byte{
	// 482 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x52
	{
		size := m.GasPriceAdjustmentFactor.Size()
		i -= size
		if _, err := m.GasPriceAdjustmentFactor.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintFeemarket(dAtA, i, uint64(size))
	}
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovFeemarket(uint64(l))
	l = m.GasPriceAdjustmentFactor.Size()
	n += 1 + l + sovFeemarket(uint64(l))
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GasPriceAdjustmentFactor", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GasPriceAdjustmentFactor.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
