...
func TestAddressFormats(t *testing.T) {
	testCases := []struct {
		...
		{"Guru Address", "guru18wvvwfmq77a6d8tza4h5sfuy2yj3jj88u6gumr", "0x3B98c72760f7BBa69D62ED6f48278451251948e7", false},
		...
		{"invalid Guru address", "guru18wvvwfmq77a6d8tza4h5sfuy2yj3jj88", "", true},
		{"empty string", "", "", true},
	}
