...
// EthereumTx wraps an Ethereum Transaction for protobuf serialization
...
// HexAddress converts a byte slice to hex address string
func HexAddress(bz []byte) string {
	return "0x" + hexutil.Encode(bz)[2:]
}
