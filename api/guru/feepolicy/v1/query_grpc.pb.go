...
//
// Query defines the feepolicy query service.
...
func (c *queryClient) Discounts(ctx context.Context, in *QueryDiscountsRequest, opts ...grpc.CallOption) (*QueryDiscountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Discounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Discount(ctx context.Context, in *QueryDiscountRequest, opts ...grpc.CallOption) (*QueryDiscountResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Discount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Discounts(context.Context, *QueryDiscountsRequest) (*QueryDiscountsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Discounts not implemented")
}
