...
func init() {
	...
	md_Allocation = File_guru_transwap_v1_authz_proto.Messages().ByName("Allocation")
...
func (x *fastReflection_Allocation) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "guru.transwap.v1.Allocation.source_port":
		return x.SourcePort != ""
	case "guru.transwap.v1.Allocation.source_channel":
		return x.SourceChannel != ""
	case "guru.transwap.v1.Allocation.spend_limit":
		return len(x.SpendLimit) != 0
	case "guru.transwap.v1.Allocation.allow_list":
		return len(x.AllowList) != 0
	case "guru.transwap.v1.Allocation.allowed_packet_data":
		return len(x.AllowedPacketData) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.transwap.v1.Allocation"))
		}
		panic(fmt.Errorf("message guru.transwap.v1.Allocation does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Allocation) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message guru.transwap.v1.Allocation does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Allocation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "guru.transwap.v1.Allocation.allowed_packet_data":
		...
		return protoreflect.ValueOfList(value)
	case "guru.transwap.v1.Allocation.source_port":
		panic(fmt.Errorf("field source_port of message guru.transwap.v1.Allocation is not mutable"))
	case "guru.transwap.v1.Allocation.source_channel":
		panic(fmt.Errorf("field source_channel of message guru.transwap.v1.Allocation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.transwap.v1.Allocation"))
		}
...
func (x *fastReflection_Allocation) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in guru.transwap.v1.Allocation", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_guru_transwap_v1_authz_proto_init()
	md_TransferAuthorization = File_guru_transwap_v1_authz_proto.Messages().ByName("TransferAuthorization")
...
func (x *fastReflection_TransferAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "guru.transwap.v1.TransferAuthorization.allocations":
		return len(x.Allocations) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.transwap.v1.TransferAuthorization"))
		}
		panic(fmt.Errorf("message guru.transwap.v1.TransferAuthorization does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TransferAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message guru.transwap.v1.TransferAuthorization does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TransferAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in guru.transwap.v1.TransferAuthorization", d.FullName()))
	}
	panic("unreachable")
}
...
var file_guru_transwap_v1_authz_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x91, 0x02, 0x0a, 0x0a, 0x41, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x65, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x6c, 0x0a, 0x0b, 0x73, 0x70, 0x65, 0x6e,
	0x64, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	...
	,
...
var file_guru_transwap_v1_authz_proto_goTypes = []interface{}{
	(*Allocation)(nil),            // 0: guru.transwap.v1.Allocation
	(*TransferAuthorization)(nil), // 1: guru.transwap.v1.TransferAuthorization
	(*v1beta1.Coin)(nil),          // 2: cosmos.base.v1beta1.Coin
}
var file_guru_transwap_v1_authz_proto_depIdxs = []int32{
	2, // 0: guru.transwap.v1.Allocation.spend_limit:type_name -> cosmos.base.v1beta1.Coin
	0, // 1: guru.transwap.v1.TransferAuthorization.allocations:type_name -> guru.transwap.v1.Allocation
