...
func init() {
	...
	md_Height = File_guru_transwap_v1_transwap_proto.Messages().ByName("Height")
...
func (x *Height) slowProtoReflect() protoreflect.Message {
	mi := &file_guru_transwap_v1_transwap_proto_msgTypes[0]
...
func (x *fastReflection_Height) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "guru.transwap.v1.Height.revision_number":
		return x.RevisionNumber != uint64(0)
	case "guru.transwap.v1.Height.revision_height":
		return x.RevisionHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.transwap.v1.Height"))
		}
		panic(fmt.Errorf("message guru.transwap.v1.Height does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Height) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message guru.transwap.v1.Height does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Height) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "guru.transwap.v1.Height.revision_number":
		panic(fmt.Errorf("field revision_number of message guru.transwap.v1.Height is not mutable"))
	case "guru.transwap.v1.Height.revision_height":
		panic(fmt.Errorf("field revision_height of message guru.transwap.v1.Height is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.transwap.v1.Height"))
		}
...
func (x *fastReflection_Height) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in guru.transwap.v1.Height", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Height) Descriptor() ([]byte, []int) {
	return file_guru_transwap_v1_transwap_proto_rawDescGZIP(), []int{0}
}
...
var File_guru_transwap_v1_transwap_proto protoreflect.FileDescriptor

var file_guru_transwap_v1_transwap_proto_rawDesc = []byte{
	,
	...
	0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0x98, 0xa0, 0x1f, 0x00, 0x42, 0xb5, 0x01, 0x0a, 0x14, 0x63,
	0x6f, 0x6d, 0x2e, 0x67, 0x75, 0x72, 0x75, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x77, 0x61, 0x70,
	0x2e, 0x76, 0x31, 0x42, 0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x77, 0x61, 0x70, 0x50, 0x72, 0x6f,
...
var (
	file_guru_transwap_v1_transwap_proto_rawDescOnce sync.Once
	file_guru_transwap_v1_transwap_proto_rawDescData = file_guru_transwap_v1_transwap_proto_rawDesc
)

func file_guru_transwap_v1_transwap_proto_rawDescGZIP() []byte {
	file_guru_transwap_v1_transwap_proto_rawDescOnce.Do(func() {
		file_guru_transwap_v1_transwap_proto_rawDescData = protoimpl.X.CompressGZIP(file_guru_transwap_v1_transwap_proto_rawDescData)
	})
	return file_guru_transwap_v1_transwap_proto_rawDescData
}

var file_guru_transwap_v1_transwap_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_guru_transwap_v1_transwap_proto_goTypes = []interface{}{
	(*Height)(nil), // 0: guru.transwap.v1.Height
}
var file_guru_transwap_v1_transwap_proto_depIdxs = []int32{
...
func init() { file_guru_transwap_v1_transwap_proto_init() }
func file_guru_transwap_v1_transwap_proto_init() {
	if File_guru_transwap_v1_transwap_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_guru_transwap_v1_transwap_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Height); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_guru_transwap_v1_transwap_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_guru_transwap_v1_transwap_proto_goTypes,
		DependencyIndexes: file_guru_transwap_v1_transwap_proto_depIdxs,
		MessageInfos:      file_guru_transwap_v1_transwap_proto_msgTypes,
	}.Build()
	File_guru_transwap_v1_transwap_proto = out.File
	file_guru_transwap_v1_transwap_proto_rawDesc = nil
	file_guru_transwap_v1_transwap_proto_goTypes = nil
	file_guru_transwap_v1_transwap_proto_depIdxs = nil
}
