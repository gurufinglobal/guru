...
func (x *_OracleVoteExtension_1_list) Get(i int) protoreflect.Value {
...
func (x *_OracleVoteExtension_1_list) Truncate(n int) {
...
func (x *_OracleVoteExtension_1_list) IsValid() bool {
	return x.list != nil
}
...
func (x *OracleVoteExtension) slowProtoReflect() protoreflect.Message {
	mi := &file_guru_oracle_v1_vote_extension_proto_msgTypes[0]
...
func (x *fastReflection_OracleVoteExtension) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message guru.oracle.v1.OracleVoteExtension does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OracleVoteExtension) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message guru.oracle.v1.OracleVoteExtension does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OracleVoteExtension) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in guru.oracle.v1.OracleVoteExtension", d.FullName()))
	}
	panic("unreachable")
}
...
var File_guru_oracle_v1_vote_extension_proto protoreflect.FileDescriptor

var file_guru_oracle_v1_vote_extension_proto_rawDesc = []byte{
	0x0a, 0x23, 0x67, 0x75, 0x72, 0x75, 0x2f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x2f, 0x76, 0x31,
	0x2f, 0x76, 0x6f, 0x74, 0x65, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x2e,
...
var (
	file_guru_oracle_v1_vote_extension_proto_rawDescOnce sync.Once
	file_guru_oracle_v1_vote_extension_proto_rawDescData = file_guru_oracle_v1_vote_extension_proto_rawDesc
)

func file_guru_oracle_v1_vote_extension_proto_rawDescGZIP() []byte {
	file_guru_oracle_v1_vote_extension_proto_rawDescOnce.Do(func() {
		file_guru_oracle_v1_vote_extension_proto_rawDescData = protoimpl.X.CompressGZIP(file_guru_oracle_v1_vote_extension_proto_rawDescData)
	})
	return file_guru_oracle_v1_vote_extension_proto_rawDescData
}
...
func init() { file_guru_oracle_v1_vote_extension_proto_init() }
func file_guru_oracle_v1_vote_extension_proto_init() {
	if File_guru_oracle_v1_vote_extension_proto != nil {
		return
	}
	file_guru_oracle_v1_oracle_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_guru_oracle_v1_vote_extension_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_guru_oracle_v1_vote_extension_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_guru_oracle_v1_vote_extension_proto_goTypes,
		DependencyIndexes: file_guru_oracle_v1_vote_extension_proto_depIdxs,
		MessageInfos:      file_guru_oracle_v1_vote_extension_proto_msgTypes,
	}.Build()
	File_guru_oracle_v1_vote_extension_proto = out.File
	file_guru_oracle_v1_vote_extension_proto_rawDesc = nil
	file_guru_oracle_v1_vote_extension_proto_goTypes = nil
	file_guru_oracle_v1_vote_extension_proto_depIdxs = nil
}
