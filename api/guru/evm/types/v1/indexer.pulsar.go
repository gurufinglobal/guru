...
func init() {
	file_guru_evm_types_v1_indexer_proto_init()
	md_TxResult = File_guru_evm_types_v1_indexer_proto.Messages().ByName("TxResult")
...
func (x *TxResult) slowProtoReflect() protoreflect.Message {
	mi := &file_guru_evm_types_v1_indexer_proto_msgTypes[0]
...
func (x *fastReflection_TxResult) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "guru.evm.types.v1.TxResult.height":
		return x.Height != int64(0)
	case "guru.evm.types.v1.TxResult.tx_index":
		return x.TxIndex != uint32(0)
	case "guru.evm.types.v1.TxResult.msg_index":
		return x.MsgIndex != uint32(0)
	case "guru.evm.types.v1.TxResult.eth_tx_index":
		return x.EthTxIndex != int32(0)
	case "guru.evm.types.v1.TxResult.failed":
		return x.Failed != false
	case "guru.evm.types.v1.TxResult.gas_used":
		return x.GasUsed != uint64(0)
	case "guru.evm.types.v1.TxResult.cumulative_gas_used":
		return x.CumulativeGasUsed != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.evm.types.v1.TxResult"))
		}
		panic(fmt.Errorf("message guru.evm.types.v1.TxResult does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TxResult) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message guru.evm.types.v1.TxResult does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TxResult) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "guru.evm.types.v1.TxResult.height":
		panic(fmt.Errorf("field height of message guru.evm.types.v1.TxResult is not mutable"))
	case "guru.evm.types.v1.TxResult.tx_index":
		panic(fmt.Errorf("field tx_index of message guru.evm.types.v1.TxResult is not mutable"))
	case "guru.evm.types.v1.TxResult.msg_index":
		panic(fmt.Errorf("field msg_index of message guru.evm.types.v1.TxResult is not mutable"))
	case "guru.evm.types.v1.TxResult.eth_tx_index":
		panic(fmt.Errorf("field eth_tx_index of message guru.evm.types.v1.TxResult is not mutable"))
	case "guru.evm.types.v1.TxResult.failed":
		panic(fmt.Errorf("field failed of message guru.evm.types.v1.TxResult is not mutable"))
	case "guru.evm.types.v1.TxResult.gas_used":
		panic(fmt.Errorf("field gas_used of message guru.evm.types.v1.TxResult is not mutable"))
	case "guru.evm.types.v1.TxResult.cumulative_gas_used":
		panic(fmt.Errorf("field cumulative_gas_used of message guru.evm.types.v1.TxResult is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: guru.evm.types.v1.TxResult"))
		}
...
func (x *fastReflection_TxResult) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in guru.evm.types.v1.TxResult", d.FullName()))
	}
	panic("unreachable")
}
...
func (*TxResult) Descriptor() ([]byte, []int) {
	return file_guru_evm_types_v1_indexer_proto_rawDescGZIP(), []int{0}
}
...
var File_guru_evm_types_v1_indexer_proto protoreflect.FileDescriptor

var file_guru_evm_types_v1_indexer_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x67, 0x75, 0x72, 0x75, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x11, 0x67, 0x75, 0x72, 0x75, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65,
	0x73, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
	0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x08, 0x54,
	...
	0x0d, 0x52, 0x07, 0x74, 0x78, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x73,
	0x67, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x6d,
	0x73, 0x67, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x20, 0x0a, 0x0c, 0x65, 0x74, 0x68, 0x5f, 0x74,
	0x78, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x65,
	0x74, 0x68, 0x54, 0x78, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x61, 0x69,
	...
	,
}

var (
	file_guru_evm_types_v1_indexer_proto_rawDescOnce sync.Once
	file_guru_evm_types_v1_indexer_proto_rawDescData = file_guru_evm_types_v1_indexer_proto_rawDesc
)

func file_guru_evm_types_v1_indexer_proto_rawDescGZIP() []byte {
	file_guru_evm_types_v1_indexer_proto_rawDescOnce.Do(func() {
		file_guru_evm_types_v1_indexer_proto_rawDescData = protoimpl.X.CompressGZIP(file_guru_evm_types_v1_indexer_proto_rawDescData)
	})
	return file_guru_evm_types_v1_indexer_proto_rawDescData
}

var file_guru_evm_types_v1_indexer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_guru_evm_types_v1_indexer_proto_goTypes = []interface{}{
	(*TxResult)(nil), // 0: guru.evm.types.v1.TxResult
}
var file_guru_evm_types_v1_indexer_proto_depIdxs = []int32{
...
func init() { file_guru_evm_types_v1_indexer_proto_init() }
func file_guru_evm_types_v1_indexer_proto_init() {
	if File_guru_evm_types_v1_indexer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_guru_evm_types_v1_indexer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_guru_evm_types_v1_indexer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_guru_evm_types_v1_indexer_proto_goTypes,
		DependencyIndexes: file_guru_evm_types_v1_indexer_proto_depIdxs,
		MessageInfos:      file_guru_evm_types_v1_indexer_proto_msgTypes,
	}.Build()
	File_guru_evm_types_v1_indexer_proto = out.File
	file_guru_evm_types_v1_indexer_proto_rawDesc = nil
	file_guru_evm_types_v1_indexer_proto_goTypes = nil
	file_guru_evm_types_v1_indexer_proto_depIdxs = nil
}
