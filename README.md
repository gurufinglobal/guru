...
validates the Constitution self-bond denomination and amount, the required
FeeMarket policy, and that both EVM denomination fields remain equal to the
immutable `config.BaseDenom` before accepting genesis.
