...
Cosmos EVM v0.7.0 uses `app-db-backend` for the application, snapshot metadata,
...
This is an operational workaround for the observed Cosmos EVM v0.7.0 indexer
