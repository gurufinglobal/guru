...
var (
	...
	UAtomDenom    = transfertypes.NewDenom("agxn", transfertypes.NewHop(transfertypes.PortID, "channel-0"))
	UAtomIbcDenom = UAtomDenom.IBCDenom()
	...
	AatomDenom    = transfertypes.NewDenom("agxn", transfertypes.NewHop(transfertypes.PortID, "channel-0"))
